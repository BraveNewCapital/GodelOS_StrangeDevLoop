...
class IntrospectionRecord(BaseModel):
    ...
    model_id: str
    prompt_hash: str
    # New optional provenance fields for direct condition-level attribution
...
def build_record(
    *,
    ...
    recursive_elements: Optional[List[str]] = None,
    confidence: Optional[float] = None,
    # New provenance passthrough fields (optional for backward compatibility)
    condition: Optional[str] = None,
    prompt_variant: Optional[str] = None,
    run_number: Optional[int] = None,
) -> IntrospectionRecord:
