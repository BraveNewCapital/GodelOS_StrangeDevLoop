...
class GodelOSSystem:
    ...
    def _init_core_components(self):
        ...
        # Knowledge store
        # In backend/production contexts, prefer backend.core.ksi_adapter.KSIAdapter or public KR endpoints (/kr/assert, /kr/retract) rather than instantiating KnowledgeStoreInterface directly.
