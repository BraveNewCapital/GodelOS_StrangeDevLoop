...
from godelOS.core_kr.knowledge_store.interface import KnowledgeStoreInterface  # In backend/production contexts, prefer KSIAdapter or public KR endpoints over direct KSI
...
def main():
    ...
    # Note: In backend/production contexts, prefer using backend.core.ksi_adapter.KSIAdapter or the public KR endpoints (/kr/assert, /kr/retract)
    # rather than instantiating KnowledgeStoreInterface directly.
