...
def main():
    ...
    # Note: In backend/production contexts, prefer using KSIAdapter or the public KR endpoints (/kr/assert, /kr/retract)
    # instead of instantiating KnowledgeStoreInterface directly.
