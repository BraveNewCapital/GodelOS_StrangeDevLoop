...
from godelOS.core_kr.knowledge_store.interface import KnowledgeStoreInterface  # Note: in backend/production, prefer KSIAdapter or public KR endpoints over direct KSI
