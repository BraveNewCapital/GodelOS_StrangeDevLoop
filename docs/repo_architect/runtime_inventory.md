...
- Two files with parse errors ("test_pipeline.py", "test_lexical_analyzer_parser.py"); blocks test coverage and signals code rot.
- 194 Python entrypoints present; high risk of duplication, fragmentation, and unclear runtime orchestration.
- Architecture score is 39; indicates significant deviation from charter goals and need for refactor prioritization.
- Immediate roadmap actions: review cycles and parse errors (non-actionable), consolidate entrypoints, and publish updated runtime inventory.
