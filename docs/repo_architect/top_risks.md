...
- 194 Python entrypoints indicate excessive duplication, unclear runtime boundaries, and hinder substrate consolidation.
...
- Immediate roadmap priorities: resolve import cycles, fix parse errors, rationalize entrypoints, and publish updated runtime inventory documentation.
