...
- 194 Python entrypoints indicate excessive duplication, unclear runtime boundaries, and hinder maintainability.
- Architecture score of 39 signals significant deviation from charter goals; core invariants (bounded recursion, operator isolation) are at risk.
- Immediate roadmap priorities: resolve import cycles, fix parse errors, consolidate entrypoints, and publish updated runtime inventory.
